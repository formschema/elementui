      ...
      on: {
        ...
        input (value) {
          /**
            ...
            * :-/
            */
          const item = data.field.items.find((item) => item.value === value)

          console.log('>', value, ':>', item, data.field.items)
          ...
          fieldset.componentInstance.value = item.value
        }
      }
    }, slots().default)
  }
